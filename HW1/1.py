...
if __name__ == '__main__':
    ...
    print('Reprojecting')
    pt_hat = reprojection(groundtruth[0], H)
    pt_hat_cv = reprojection(groundtruth[0], M)
    print('Calculating Error')
    error = calculate_error(pt_hat, groundtruth[1])
    error_cv = calculate_error(pt_hat_cv, groundtruth[1])
    ...
    print('Reprojecting')
    pt_hat_norm = reprojection(groundtruth[0], H_norm)
    print('Calculating Error \n')
    error_norm = calculate_error(pt_hat_norm, groundtruth[1])
